...
public class Day3 {
    ...
    private static List<Vector> parsePoints(String[] points) {
        ...
        for (int i = 0; i < points.length; i++) {
            Vector v = Vector.fromVectorAndDirection(
                    lastVector,
                    Direction.valueOf(points[i].substring(0, 1)),
                    Integer.parseInt(points[i].substring(1)));
            vectors.add(v);
            lastVector = v;
        }
    ...
    static final String[] WIRE2 = new String[]{
